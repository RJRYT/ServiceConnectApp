...
function Login() {
  ...
  return (
    <div className="h-screen px-5 w-full bg-gray-300 flex justify-center items-center py-3">
      <div className="w-full max-w-md bg-gray-300 p-8 mt-12 rounded-xl flex flex-col items-center">
        ...
        <div className="w-full flex flex-col gap-5 relative">
          ...
          <button className="bg-slate-900 text-white py-3 rounded-full mt-2 flex justify-center items-center w-full hover:bg-slate-700 transition relative">
            ...
            <div className="absolute flex justify-center items-center right-2">
              <img className="w-10" src={round} alt="oval decoration" />
