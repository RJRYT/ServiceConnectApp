  ...
  return (
    <div className=" fixed bottom-0 left-0 mb-5 sm:hidden h-[55px] w-[400px] flex justify-center ">
        <div className='w-[80%] h-full bg-[#736a68] flex items-center justify-center gap-8 rounded-2xl p-2'>
            ...
            <img src={booklist} className='text-white h-5 w-4 cursor-pointer transform hover:scale-150 trasition-all duration-500 active:scale-[0.9]'/>
            <img src={timer} className='text-white  h-5 w-5 cursor-pointer transform hover:scale-150 trasition-all duration-500 active:scale-[0.9]'/>
            <img src={vector} className='text-white  h-5 w-5 cursor-pointer transform hover:scale-150 trasition-all duration-500 active:scale-[0.9]'/>
            <FaPlus className='text-white text-[20px] text-white cursor-pointer transform hover:scale-150 trasition-all duration-500 active:scale-[0.9]'/>
